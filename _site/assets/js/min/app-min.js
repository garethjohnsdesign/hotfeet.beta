...
c=(kt.cssNumber[e]||"px"!==u&&+l)&&Qt.exec(kt.css(t,e));if(c&&c[3]!==u){for(
// Support: Firefox <=54
...
function $(t,e){for(var n=0,i=t.length;n<i;n++)Nt.set(t[n],"globalEval",!e||Nt.get(e[n],"globalEval"))}function k(t,e,n,i,o){for(var r,s,a,l,u,c,d=e.createDocumentFragment(),f=[],h=0,p=t.length;h<p;h++)if((r=t[h])||0===r)
// Add nodes directly
if("object"===g(r))
...
function T(t,e){return u(t,"table")&&u(11!==e.nodeType?e:e.firstChild,"tr")&&kt(t).children("tbody")[0]||t}
...
if(Nt.hasData(t)&&(r=Nt.access(t),s=Nt.set(e,r),u=r.events))for(o in delete s.handle,s.events={},u)for(n=0,i=u[o].length;n<i;n++)kt.event.add(e,o,u[o][n]);
// 2. Copy user data
...
// Reenable scripts
kt.map(s,z),c=0;c<a;c++)l=s[c],Jt.test(l.type||"")&&!Nt.access(l,"globalEval")&&kt.contains(u,l)&&(l.src&&"module"!==(l.type||"").toLowerCase()?
// Optional AJAX dependency, but won't run scripts if not present
kt._evalUrl&&kt._evalUrl(l.src):m(l.textContent.replace(fe,""),u,l))}return n}function D(t,e,n){for(var i,o=e?kt.filter(e,t):t,r=0;null!=(i=o[r]);r++)n||1!==i.nodeType||kt.cleanData(w(i)),i.parentNode&&(n&&kt.contains(i.ownerDocument,i)&&$(w(i,"script")),i.parentNode.removeChild(i));return t}function L(t,e,n){var i,o,r,s,
// Support: Firefox 51+
...
"margin"===n&&(l+=kt.css(t,n+Yt[s],!0,o)),
// If we get here with a content-box, we're seeking "padding" or "border" or "margin"
i?(
// For "content", subtract padding
"content"===n&&(l-=kt.css(t,"padding"+Yt[s],!0,o)),
// For "content" or "padding", subtract border
"margin"!==n&&(l-=kt.css(t,"border"+Yt[s]+"Width",!0,o))):(
// Add padding
l+=kt.css(t,"padding"+Yt[s],!0,o),
// For "border" or "margin", add border
"padding"!==n?l+=kt.css(t,"border"+Yt[s]+"Width",!0,o):a+=kt.css(t,"border"+Yt[s]+"Width",!0,o));
...
var i=pe(t),o=L(t,e,i),r="border-box"===kt.css(t,"boxSizing",!1,i),s=r;
// Support: Firefox <=54
...
return i}function Y(t,e,n){var i,o,r,s,a,l,u,c,d="width"in e||"height"in e,f=this,h={},p=t.style,m=t.nodeType&&Kt(t),g=Nt.get(t,"fxshow");
...
u=g&&g.display)&&(u=Nt.get(t,"display")),"none"===(c=kt.css(t,"display"))&&(u?c=u:(
...
m||b([t]),Nt.remove(t,"fxshow"),h)kt.style(t,i,h[i])})),
// Per-property setup
l=Q(m?g[i]:0,i,f),i in g||(g[i]=l.start,m&&(l.end=l.start,l.start=0))}function K(t,e){var n,i,o,r,s;
...
for(n in r=s.expand(r),delete t[i],r)n in t||(t[n]=r[n],e[n]=o);else e[i]=o}function U(s,t,e){var n,a,i=0,o=U.prefilters.length,l=kt.Deferred().always(function(){
...
return t?(l.notifyWith(s,[u,1,0]),l.resolveWith(s,[u,t])):l.rejectWith(s,[u,t]),this}}),c=u.props;for(K(c,u.opts.specialEasing);i<o;i++)if(n=U.prefilters[i].call(u,s,c,u.opts))return yt(n.stop)&&(kt._queueHooks(u.elem,u.opts.queue).stop=n.stop.bind(n)),n;return kt.map(c,Q,u),yt(u.opts.start)&&u.opts.start.call(s,u),
...
if(k.qsa&&!Q[t+" "]&&(!q||!q.test(t))){if(1!==f)d=e,c=t;else if("object"!==e.nodeName.toLowerCase()){for(
// Capture the context ID, setting it first if necessary
(a=e.getAttribute("id"))?a=a.replace($t,kt):e.setAttribute("id",a=I),r=(
...
o[c]=s)[2]=a(t,e,n))return!0}return!1}}function f(o){return 1<o.length?function(t,e,n){for(var i=o.length;i--;)if(!o[i](t,e,n))return!1;return!0}:o[0]}function y(t,e,n){for(var i=0,o=e.length;i<o;i++)w(t,e[i],n);return n}function $(t,e,n,i,o){for(var r,s=[],a=0,l=t.length,u=null!=e;a<l;a++)(r=t[a])&&(n&&!n(r,i,o)||(s.push(r),u&&e.push(a)));return s}function b(h,p,m,g,v,t){return g&&!g[I]&&(g=b(g)),v&&!v[I]&&(v=b(v,t)),l(function(t,e,n,i){var o,r,s,a=[],l=[],u=e.length,
...
if((e=x.filter[t[a].type].apply(null,t[a].matches))[I]){for(
...
for(o&&(S=e===P||e||o);u!==m&&null!=(r=h[u]);u++){if(b&&r){for(s=0,e||r.ownerDocument===P||(A(r),n=!L);a=g[s++];)if(a(r,e||P,n)){i.push(r);break}o&&(F=p)}
...
return o&&(F=p,S=f),c};return y?l(t):t}var v,k,x,_,j,C,O,T,S,z,E,
// Local document vars
A,P,D,L,q,M,H,R,
...
k.getById=o(function(t){return D.appendChild(t).id=I,!P.getElementsByName||!P.getElementsByName(I).length}),
// ID filter and find
k.getById?(x.filter.ID=function(t){var e=t.replace(bt,wt);return function(t){return t.getAttribute("id")===e}},x.find.ID=function(t,e){if(void 0!==e.getElementById&&L){var n=e.getElementById(t);return n?[n]:[]}}):(x.filter.ID=function(t){var n=t.replace(bt,wt);return function(t){var e=void 0!==t.getAttributeNode&&t.getAttributeNode("id");return e&&e.value===n}},
// Support: IE 6 - 7 only
// getElementById is not reliable as a find shortcut
x.find.ID=function(t,e){if(void 0!==e.getElementById&&L){var n,i,o,r=e.getElementById(t);if(r){if((
...
// Class
x.find.CLASS=k.getElementsByClassName&&function(t,e){if(void 0!==e.getElementsByClassName&&L)return e.getElementsByClassName(t)},
/* QSA/matchesSelector
	---------------------------------------------------------------------- */
...
D.appendChild(t).innerHTML="<a id='"+I+"'></a><select id='"+I+"-\r\\' msallowcapture=''><option selected=''></option></select>",
...
t.querySelectorAll("*,:x"),q.push(",.*:")})),(k.matchesSelector=gt.test(H=D.matches||D.webkitMatchesSelector||D.mozMatchesSelector||D.oMatchesSelector||D.msMatchesSelector))&&o(function(t){
...
R=e||gt.test(D.contains)?function(t,e){var n=9===t.nodeType?t.documentElement:t,i=e&&e.parentNode;return t===i||!(!i||1!==i.nodeType||!(n.contains?n.contains(i):t.compareDocumentPosition&&16&t.compareDocumentPosition(i)))}:function(t,e){if(e)for(;e=e.parentNode;)if(e===t)return!0;return!1},
/* Sorting
	---------------------------------------------------------------------- */
...
t===P||t.ownerDocument===N&&R(N,t)?-1:e===P||e.ownerDocument===N&&R(N,e)?1:z?tt(z,t)-tt(z,e):0:4&n?-1:1)}:function(t,e){
...
e=e.replace(ct,"='$1']"),k.matchesSelector&&L&&!Q[e+" "]&&(!M||!M.test(e))&&(!q||!q.test(e)))try{var n=H.call(t,e);
...
i=n&&K.call(x.attrHandle,e.toLowerCase())?n(t,e,!L):void 0;return void 0!==i?i:k.attributes||!L?t.getAttribute(e):(i=t.getAttributeNode(e))&&i.specified?i.value:null},w.escape=function(t){return(t+"").replace($t,kt)},w.error=function(t){throw new Error("Syntax error, unrecognized expression: "+t)},
/**
...
if(E=!k.detectDuplicates,z=!k.sortStable&&t.slice(0),t.sort(Y),E){for(;e=t[o++];)e===t[o]&&(i=n.push(o));for(;i--;)t.splice(n[i],1)}
...
r=c[0]=c[0].slice(0)).length&&"ID"===(s=r[0]).type&&9===e.nodeType&&L&&x.relative[r[1].type]){if(!(e=(x.find.ID(s.matches[0].replace(bt,wt),e)||[])[0]))return n;
...
// Compile and execute a filtering function if one is not provided
// Provide `match` to avoid retokenization if we modified the selector above
return(u||O(t,c))(i,e,!L,n,!e||yt.test(t)&&h(e.parentNode)||e),n},
// One-time assignments
// Sort stability
k.sortStable=I.split("").sort(Y).join("")===I,
...
kt.merge(this,kt.parseHTML(i[1],e&&e.nodeType?e.ownerDocument||e:st,!0)),Tt.test(i[1])&&kt.isPlainObject(e))for(i in e)
...
var Lt=/^(Eval|Internal|Range|Reference|Syntax|Type|URI)Error$/;kt.Deferred.exceptionHook=function(t,e){
// Support: IE 8 - 9 only
// Console exists when dev tools are open, which can happen at any time
x.console&&x.console.warn&&t&&Lt.test(t.name)&&x.console.warn("jQuery.Deferred exception: "+t.message,t.stack,e)},kt.readyException=function(t){x.setTimeout(function(){throw t})};
...
e=Array.isArray(e)?e.map(h):(e=h(e))in i?[e]:e.match(Dt)||[]).length;for(;n--;)delete i[e[n]]}
...
t.nodeType?t[this.expando]=void 0:delete t[this.expando])}},hasData:function(t){var e=t[this.expando];return void 0!==e&&!kt.isEmptyObject(e)}};var Nt=new r,Ft=new r,Bt=/^(?:\{[\w\W]*\}|\[[\w\W]*\])$/,Wt=/[A-Z]/g;kt.extend({hasData:function(t){return Ft.hasData(t)||Nt.hasData(t)},data:function(t,e,n){return Ft.access(t,e,n)},removeData:function(t,e){Ft.remove(t,e)},
// TODO: Now that all calls to _data and _removeData have been replaced
// with direct calls to dataPriv methods, these can be deprecated.
_data:function(t,e,n){return Nt.access(t,e,n)},_removeData:function(t,e){Nt.remove(t,e)}}),kt.fn.extend({data:function(n,t){var e,i,o,r=this[0],s=r&&r.attributes;
// Gets all values
if(void 0!==n)
...
s[e]&&0===(i=s[e].name).indexOf("data-")&&(i=h(i.slice(5)),p(r,i,o[i]));Nt.set(r,"hasDataAttrs",!0)}return o},removeData:function(t){return this.each(function(){Ft.remove(this,t)})}}),kt.extend({queue:function(t,e,n){var i;if(t)return e=(e||"fx")+"queue",i=Nt.get(t,e),
// Speed up dequeue by getting out quickly if this is just a lookup
n&&(!i||Array.isArray(n)?i=Nt.access(t,e,kt.makeArray(n)):i.push(n)),i||[]},dequeue:function(t,e){e=e||"fx";var n=kt.queue(t,e),i=n.length,o=n.shift(),r=kt._queueHooks(t,e),s=function(){kt.dequeue(t,e)};
...
_queueHooks:function(t,e){var n=e+"queueHooks";return Nt.get(t,n)||Nt.access(t,n,{empty:kt.Callbacks("once memory").add(function(){Nt.remove(t,[e+"queue",n])})})}}),kt.fn.extend({queue:function(e,n){var t=2;return"string"!=typeof e&&(n=e,e="fx",t--),arguments.length<t?kt.queue(this[0],e):void 0===n?this:this.each(function(){var t=kt.queue(this,e,n);
...
promise:function(t,e){var n,i=1,o=kt.Deferred(),r=this,s=this.length,a=function(){--i||o.resolveWith(r,[r])};for("string"!=typeof t&&(e=t,t=void 0),t=t||"fx";s--;)(n=Nt.get(r[s],t+"queueHooks"))&&n.empty&&(i++,n.empty.add(a));return a(),o.promise(e)}});var Gt=/[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source,Qt=new RegExp("^(?:([+-])=|)("+Gt+")([a-z%]*)$","i"),Yt=["Top","Right","Bottom","Left"],Kt=function(t,e){
...
// in the document.
kt.contains(t.ownerDocument,t)&&"none"===kt.css(t,"display")},Ut=function(t,e,n,i){var o,r,s={};
// Remember the old values, and insert the new ones
for(r in e)s[r]=t.style[r],t.style[r]=e[r];
// Revert the old values
for(r in o=n.apply(t,i||[]),e)t.style[r]=s[r];return o},Vt={};kt.fn.extend({show:function(){return b(this,!0)},hide:function(){return b(this)},toggle:function(t){return"boolean"==typeof t?t?this.show():this.hide():this.each(function(){Kt(this)?kt(this).show():kt(this).hide()})}});var Xt=/^(?:checkbox|radio)$/i,Zt=/<([a-z][^\/\0>\x20\t\r\n\f]+)/i,Jt=/^$|^module$|\/(?:java|ecma)script/i,te={
// Support: IE <=9 only
...
ie.innerHTML="<textarea>x</textarea>",vt.noCloneChecked=!!ie.cloneNode(!0).lastChild.defaultValue;var re=st.documentElement,se=/^key/,ae=/^(?:mouse|pointer|contextmenu|drag|drop)|click/,le=/^([^.]*)(?:\.(.+)|)/;kt.event={global:{},add:function(e,t,n,i,o){var r,s,a,l,u,c,d,f,h,p,m,g=Nt.get(e);
...
t=(t||"").match(Dt)||[""]).length;u--;)h=m=(a=le.exec(t[u])||[])[1],p=(a[2]||"").split(".").sort(),
...
kt.isEmptyObject(l)&&Nt.remove(t,"handle events")}},dispatch:function(t){
// Make a writable jQuery.Event from the native event object
var e=kt.event.fix(t),n,i,o,r,s,a,l=new Array(arguments.length),u=(Nt.get(this,"events")||{})[e.type]||[],c=kt.event.special[e.type]||{};for(
...
return i&&(i===n||kt.contains(n,i))||(t.type=o.origType,e=o.handler.apply(this,arguments),t.type=r),e}}}),kt.fn.extend({on:function(t,e,n,i){return O(this,t,e,n,i)},one:function(t,e,n,i){return O(this,t,e,n,i,1)},off:function(t,e,n){var i,o;if(t&&t.preventDefault&&t.handleObj)
...
var e=t.ownerDocument.defaultView;return e&&e.opener||(e=x),e.getComputedStyle(t)},me=new RegExp(Yt.join("|"),"i");!function(){
...
t.getClientRects().length&&t.getBoundingClientRect().width?N(t,a,n):Ut(t,ye,function(){return N(t,a,n)})},set:function(t,e,n){var i,o=pe(t),r="border-box"===kt.css(t,"boxSizing",!1,o),s=n&&I(t,a,n,r,o);
...
kt.fx.step={};var ke,xe,_e=/^(?:toggle|show|hide)$/,je=/queueHooks$/,Ce,Oe,Te;kt.Animation=kt.extend(U,{tweeners:{"*":[function(t,e){var n=this.createTween(t,e);return v(n.elem,t,Qt.exec(e),n),n}]},tweener:function(t,e){for(var n,i=0,o=(t=yt(t)?(e=t,["*"]):t.match(Dt)).length;i<o;i++)n=t[i],U.tweeners[n]=U.tweeners[n]||[],U.tweeners[n].unshift(e)},prefilters:[Y],prefilter:function(t,e){e?U.prefilters.unshift(t):U.prefilters.push(t)}}),kt.speed=function(t,e,n){var i=t&&"object"==typeof t?kt.extend({},t):{complete:n||!n&&e||yt(t)&&t,duration:t,easing:n&&e||e&&!yt(e)&&e};
...
return this.filter(Kt).css("opacity",0).show().end().animate({opacity:e},t,n,i)},animate:function(e,t,n,i){var o=kt.isEmptyObject(e),r=kt.speed(t,n,i),s=function(){
// Operate on a copy of prop so per-property easing won't be lost
var t=U(this,kt.extend({},e),r);
// Empty animations, or finishing resolves immediately
(o||Nt.get(this,"finish"))&&t.stop(!0)};return s.finish=s,o||!1===r.queue?this.each(s):this.queue(r.queue,s)},stop:function(o,t,r){var s=function(t){var e=t.stop;delete t.stop,e(r)};return"string"!=typeof o&&(r=t,t=o,o=void 0),t&&!1!==o&&this.queue(o||"fx",[]),this.each(function(){var t=!0,e=null!=o&&o+"queueHooks",n=kt.timers,i=Nt.get(this);if(e)i[e]&&i[e].stop&&s(i[e]);else for(e in i)i[e]&&i[e].stop&&je.test(e)&&s(i[e]);for(e=n.length;e--;)n[e].elem!==this||null!=o&&n[e].queue!==o||(n[e].anim.stop(r),t=!1,n.splice(e,1));
// Start the next in the queue if the last step wasn't forced.
// Timers currently will call their complete callbacks, which
// will dequeue but only if they were gotoEnd.
!t&&r||kt.dequeue(this,o)})},finish:function(s){return!1!==s&&(s=s||"fx"),this.each(function(){var t,e=Nt.get(this),n=e[s+"queue"],i=e[s+"queueHooks"],o=kt.timers,r=n?n.length:0;
...
kt.fn.delay=function(i,t){return i=kt.fx&&kt.fx.speeds[i]||i,t=t||"fx",this.queue(t,function(t,e){var n=x.setTimeout(t,i);e.stop=function(){x.clearTimeout(n)}})},Ce=st.createElement("input"),Te=st.createElement("select").appendChild(st.createElement("option")),Ce.type="checkbox",
...
Ce=st.createElement("input")).value="t",Ce.type="radio",vt.radioValue="t"===Ce.value;var Se,ze=kt.expr.attrHandle;kt.fn.extend({attr:function(t,e){return Mt(this,kt.attr,t,e,1<arguments.length)},removeAttr:function(t){return this.each(function(){kt.removeAttr(this,t)})}}),kt.extend({attr:function(t,e,n){var i,o,r=t.nodeType;
...
o=ze[r],ze[r]=i,i=null!=s(t,e,n)?r:null,ze[r]=o),i}});var Ee=/^(?:input|select|textarea|button)$/i,Ae=/^(?:a|area)$/i;kt.fn.extend({prop:function(t,e){return Mt(this,kt.prop,t,e,1<arguments.length)},removeProp:function(t){return this.each(function(){delete this[kt.propFix[t]||t]})}}),kt.extend({prop:function(t,e,n){var i,o,r=t.nodeType;
...
var e=kt.find.attr(t,"tabindex");return e?parseInt(e,10):Ee.test(t.nodeName)||Ae.test(t.nodeName)&&t.href?0:-1}}},propFix:{for:"htmlFor",class:"className"}}),
// Support: IE <=11 only
...
vt.focusin="onfocusin"in x;var De=/^(?:focusinfocus|focusoutblur)$/,Le=function(t){t.stopPropagation()};kt.extend(kt.event,{trigger:function(t,e,n,i){var o,r,s,a,l,u,c,d,f=[n||st],h=pt.call(t,"type")?t.type:t,p=pt.call(t,"namespace")?t.namespace.split("."):[];
// Don't do events on text and comment nodes
if(r=d=s=n=n||st,3!==n.nodeType&&8!==n.nodeType&&!De.test(h+kt.event.triggered)&&(-1<h.indexOf(".")&&(
...
if(!i&&!c.noBubble&&!bt(n)){for(a=c.delegateType||h,De.test(a+h)||(r=r.parentNode);r;r=r.parentNode)f.push(r),s=r;
...
kt.event.triggered=h,t.isPropagationStopped()&&d.addEventListener(h,Le),n[h](),t.isPropagationStopped()&&d.removeEventListener(h,Le),kt.event.triggered=void 0,s&&(n[l]=s)),t.result}
...
var o=function(t){kt.event.simulate(i,t.target,kt.event.fix(t))};kt.event.special[i]={setup:function(){var t=this.ownerDocument||this,e=Nt.access(t,i);e||t.addEventListener(n,o,!0),Nt.access(t,i,(e||0)+1)},teardown:function(){var t=this.ownerDocument||this,e=Nt.access(t,i)-1;e?Nt.access(t,i,e):(t.removeEventListener(n,o,!0),Nt.remove(t,i))}}});var qe=x.location,Me=Date.now(),He=/\?/;
// Cross-browser xml parsing
kt.parseXML=function(t){var e;if(!t||"string"!=typeof t)return null;
// Support: IE 9 - 11 only
// IE throws on parseFromString with invalid input.
try{e=(new x.DOMParser).parseFromString(t,"text/xml")}catch(t){e=void 0}return e&&!e.getElementsByTagName("parsererror").length||kt.error("Invalid XML: "+t),e};var Re=/\[\]$/,Ie=/\r?\n/g,Ne=/^(?:submit|button|image|reset|file)$/i,Fe=/^(?:input|select|textarea|keygen)/i;kt.param=function(t,e){var n,i=[],o=function(t,e){
...
return this.name&&!kt(this).is(":disabled")&&Fe.test(this.nodeName)&&!Ne.test(t)&&(this.checked||!Xt.test(t))}).map(function(t,e){var n=kt(this).val();return null==n?null:Array.isArray(n)?kt.map(n,function(t){return{name:e.name,value:t.replace(Ie,"\r\n")}}):{name:e.name,value:n.replace(Ie,"\r\n")}}).get()}});var Be=/%20/g,We=/#.*$/,Ge=/([?&])_=[^&]*/,Qe=/^(.*?):[ \t]*([^\r\n]*)$/gm,
...
lastModified:{},etag:{},ajaxSettings:{url:qe.href,type:"GET",isLocal:Ye.test(qe.protocol),global:!0,processData:!0,async:!0,contentType:"application/x-www-form-urlencoded; charset=UTF-8",
/*
		timeout: 0,
		data: null,
		dataType: null,
...
getResponseHeader:function(t){var e;if(p){if(!i)for(i={};e=Qe.exec(f);)i[e[1].toLowerCase()]=e[2];e=i[t.toLowerCase()]}return null==e?null:e},
// Raw string
...
i=(e=st.implementation.createHTMLDocument("")).createElement("base")).href=st.location.href,e.head.appendChild(i)):e=st),r=!n&&[],(o=Tt.exec(t))?[e.createElement(o[1])]:(o=k([t],e,r),r&&r.length&&kt(r).remove(),kt.merge([],o.childNodes)));var i,o,r},
/**
...
return e=L(t,n),he.test(e)?kt(t).position()[n]+"px":e})}),
...
// touch events
"ontouchstart"in window&&(window.addEventListener("touchstart",x,e),window.addEventListener("touchend",y))),
// mouse wheel
window.addEventListener(j(),w,e),
// keyboard events
window.addEventListener("keydown",x),window.addEventListener("keyup",x),
// focus events
window.addEventListener("focusin",$),window.addEventListener("focusout",k)},y=function t(e){
// only execute if the event buffer timer isn't running
if(!m){var n=e.which,i=p[e.type];"pointer"===i&&(i=_(e));var o=!h.length&&-1===f.indexOf(n),r=h.length&&-1!==h.indexOf(n),s="keyboard"===i&&n&&(o||r)||"mouse"===i||"touch"===i;if(u!==i&&s){u=i;try{window.sessionStorage.setItem("what-input",u)}catch(t){}b("input")}if(c!==i&&s){
...
T(e),!m&&!s){var n=p[e.type];if("pointer"===n&&(n=_(e)),c!==n){c=n;try{window.sessionStorage.setItem("what-intent",c)}catch(t){}b("intent")}}},$=function t(e){e.target.nodeName?(i=e.target.nodeName.toLowerCase(),n.setAttribute("data-whatelement",i),e.target.classList&&e.target.classList.length&&n.setAttribute("data-whatclasses",e.target.classList.toString().replace(" ",","))):
// If nodeName is undefined, clear the element
// This can happen if click inside an <svg> element.
k()},k=function t(){i=null,n.removeAttribute("data-whatelement"),n.removeAttribute("data-whatclasses")},x=function t(e){
...
m=!1},100)},_=function t(e){return"number"==typeof e.pointerType?l[e.pointerType]:"pen"===e.pointerType?"touch":e.pointerType},j=function t(){var e=void 0;
